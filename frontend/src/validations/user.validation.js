...
export const userSchema = yup.object({
    first_name: yup.string().required("Vui lòng nhập tên").min(3, "Vui lòng nhập ít nhất 3 ký tự").max(30, "Tên người dùng tối đa 30 ký tự"),
    last_name: yup.string().required("Vui lòng nhập họ lót").min(3, "Vui lòng nhập ít nhất 3 ký tự").max(30, "Họ lót người dùng tối đa 30 ký tự"),
    ...
    phone: yup.string().required("Vui lòng nhập số điện thoại").matches(/^(09|03|07|08|05)/, "Đầu số điện thoại không hợp lệ.")
