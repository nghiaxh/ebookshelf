...
export const bookSchema = yup.object({
    ...
    quantity: yup.number().required("Vui lòng nhập số lượng").min(1, "Số lượng sách tối thiểu là 1 quyển").typeError("Vui lòng nhập số lượng"),
    ...
    published_year: yup.number().required("Vui lòng nhập năm xuất bản").min(0, "Năm xuất bản không hợp lệ").typeError("Vui lòng nhập năm xuất bản")
});